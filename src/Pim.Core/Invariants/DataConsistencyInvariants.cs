...
public static class DataConsistencyInvariants
{
    ...
    /// 容差: 桶数量 * 1秒（每桶舍入误差）
    /// </summary>
    public static InvariantResult CheckOverviewEqualsHeatmapSum(
    ...
    /// </summary>
    public static InvariantResult CheckOverviewEqualsDailyTrendSum(
    ...
    /// </summary>
    public static InvariantResult CheckAppCountConsistency(
    ...
    /// </summary>
    public static InvariantResult CheckCrossModuleDayAlignment(
    ...
    /// </summary>
    public static InvariantResult CheckCategoryShareSumToHundred(
    ...
    /// </summary>
    public static InvariantResult CheckHeatmapHourCoverage(
    ...
    /// </summary>
    public static InvariantResult CheckDeviceMergeDataIntegrity(
    ...
    /// </summary>
    public static InvariantResult CheckDeviceDeleteCascade(
    ...
    /// </summary>
    public static InvariantResult CheckHeatmapGranularityBucketCount(
    ...
    /// </summary>
    public static InvariantResult CheckTimelineBlocksOrdered(
    ...
    /// </summary>
    public static InvariantResult CheckAppCountBounded(
    ...
    /// </summary>
    public static InvariantResult CheckQualityCompletenessFallbackRelation(
    ...
    /// </summary>
    public static InvariantResult CheckDailyTrendVsHeatmapByDate(
    ...
    /// </summary>
    public static InvariantResult CheckSwitchCountBounded(int switchCount, int totalSessionCount)
    {
        if (switchCount < 0)
    ...
    /// </summary>
    public static InvariantResult CheckHeatmapBucketValidity(
    ...
    /// </summary>
    public static InvariantResult CheckDailyTrendDateFormat(
        List<string> dates)
    {
    ...
    /// </summary>
    public static InvariantResult CheckDeviceMergePackageDistinct(
