...
public sealed class MobileAppClassificationService
{
    ...
    private static string NormalizeLifeCategory(string? lifeCategory)
        => MobileLifeCategories.All.Contains(lifeCategory)
            ? lifeCategory!
            : MobileLifeCategories.Uncategorized;
    ...
    {
        ["com.tencent.mm"] = new(MobileLifeCategories.Social),
        ["com.tencent.mobileqq"] = new(MobileLifeCategories.Social),
        ["com.sina.weibo"] = new(MobileLifeCategories.Social),
        ["com.eg.android.alipaygphone"] = new(MobileLifeCategories.FinancePayment),
        ["com.tencent.mm.plugin.brandservice"] = new(MobileLifeCategories.Social),
        ["com.taobao.taobao"] = new(MobileLifeCategories.ShoppingFood),
        ["com.jingdong.app.mall"] = new(MobileLifeCategories.ShoppingFood),
        ["com.sankuai.meituan"] = new(MobileLifeCategories.ShoppingFood),
        ["me.ele"] = new(MobileLifeCategories.ShoppingFood),
        ["com.ss.android.ugc.aweme"] = new(MobileLifeCategories.ShortVideoEntertainment),
        ["com.smile.gifmaker"] = new(MobileLifeCategories.ShortVideoEntertainment),
        ["tv.danmaku.bili"] = new(MobileLifeCategories.ShortVideoEntertainment),
        ["com.netease.cloudmusic"] = new(MobileLifeCategories.MusicAudio),
        ["com.tencent.qqmusic"] = new(MobileLifeCategories.MusicAudio),
        ["com.zhihu.android"] = new(MobileLifeCategories.ReadingNews),
        ["com.youdao.dict"] = new(MobileLifeCategories.Learning),
        ["com.autonavi.minimap"] = new(MobileLifeCategories.TravelMaps),
        ["com.baidu.baidumap"] = new(MobileLifeCategories.TravelMaps),
    ...
    [
        ("com.tencent.tim", new BuiltInClassification(MobileLifeCategories.Social)),
    ...
    [
        ("browser", new BuiltInClassification(MobileLifeCategories.BrowserSearch)),
        ("search", new BuiltInClassification(MobileLifeCategories.BrowserSearch)),
        ("map", new BuiltInClassification(MobileLifeCategories.TravelMaps)),
        ("music", new BuiltInClassification(MobileLifeCategories.MusicAudio)),
        ("camera", new BuiltInClassification(MobileLifeCategories.CameraCreation)),
        ("pay", new BuiltInClassification(MobileLifeCategories.FinancePayment)),
    ...
    private static readonly Dictionary<string, string> AndroidCategoryMap = new(StringComparer.Ordinal)
    {
        ...
        ["magazines"] = MobileLifeCategories.ReadingNews,
        ["books"] = MobileLifeCategories.ReadingNews,
