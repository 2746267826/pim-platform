...
public static class ExhibitionDataInvariants
{
    ...
    public static InvariantResult CheckSummaryEqualsHeatmap(
    ...
    public static InvariantResult CheckCategoryShareHundred(IReadOnlyList<double> percentages)
    {
    ...
    public static InvariantResult CheckHeatmapHoursFull(IReadOnlyList<int> hours)
    {
    ...
    public static InvariantResult CheckGpsContinuity(IReadOnlyList<(double lat, double lng)> points)
    {
    ...
    public static InvariantResult CheckTaskRateRange(IReadOnlyList<double> rates)
    {
