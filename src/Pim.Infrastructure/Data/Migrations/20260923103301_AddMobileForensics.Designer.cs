...
namespace Pim.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260923103301_AddMobileForensics")]
    partial class AddMobileForensics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pim.Module.Calendar.Entities.EventEntity", b =>
                {
                    ...
                    b.Property<bool>("IsSeriesMaster")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_series_master");
                    ...
                    b.HasIndex("SeriesMasterId", "RecurrenceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Pim.Module.Files.Entities.FileProviderEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DeltaResetAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("delta_reset_at");

                    b.Property<byte[]>("DeviceCodeEncrypted")
                        .HasColumnType("bytea")
                        .HasColumnName("device_code_encrypted");

                    b.Property<DateTimeOffset?>("DeviceCodeExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("device_code_expires_at");
                    ...
                    b.Property<long>("SyncedItemCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("synced_item_count");
            ...
            modelBuilder.Entity("Pim.Module.Mcp.Entities.McpClientEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LastTool")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)")
                        .HasColumnName("last_tool");
                    ...
                    b.Property<long>("WriteCallCount")
                        .HasColumnType("bigint")
                        .HasColumnName("write_call_count");
            ...
            modelBuilder.Entity("Pim.Module.Mobile.Entities.MobileDroppedReasonDailyEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "DeviceId", "LocalDate");

                    b.HasIndex("UserId", "DeviceId", "LocalDate", "Reason")
                        .IsUnique();

                    b.ToTable("mobile_dropped_reason_daily");
                });

            modelBuilder.Entity("Pim.Module.Mobile.Entities.MobileForensicEventEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ClientItemKey")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("client_item_key");
                    ...
                    b.HasIndex("UserId", "DeviceId", "ClientItemKey")
                        .IsUnique();

                    b.HasIndex("UserId", "DeviceId", "OccurredAtUtc");

                    b.HasIndex("UserId", "DeviceId", "EventType", "OccurredAtUtc");

                    b.ToTable("mobile_forensic_events");
                });
            ...
            modelBuilder.Entity("Pim.Module.Mobile.Entities.MobileLocationPointEntity", b =>
                {
                    ...
                    b.HasIndex("UserId", "DeviceId", "RecordedAtUtc", "Latitude", "Longitude")
                        .IsUnique();
            ...
            modelBuilder.Entity("Pim.Module.PcTracker.Entities.ActivityClassificationEntity", b =>
                {
                    ...
                    b.Property<string>("AppDisplayName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("app_display_name");
            ...
            modelBuilder.Entity("Pim.Module.PcTracker.Entities.ActivityClassificationSettingsEntity", b =>
                {
                    ...
                    b.Property<double>("DailyProductiveHoursGoal")
                        .HasColumnType("double precision")
                        .HasColumnName("daily_productive_hours_goal");
            ...
            modelBuilder.Entity("Pim.Module.PcTracker.Entities.PcBrowserSiteDailyEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("FocusMs")
                        .HasColumnType("bigint")
                        .HasColumnName("focus_ms");
                    ...
                    b.Property<long>("MediaMs")
                        .HasColumnType("bigint")
                        .HasColumnName("media_ms");

                    b.Property<long>("RunMs")
                        .HasColumnType("bigint")
                        .HasColumnName("run_ms");
                    ...
                    b.ToTable("pc_browser_site_daily");
                });

            modelBuilder.Entity("Pim.Module.PcTracker.Entities.PcBrowserSiteMetaEntity", b =>
                {
                    b.Property<string>("Host")
                        .HasMaxLength(253)
                        .HasColumnType("character varying(253)")
                    ...
                    b.ToTable("pc_browser_site_meta");
                });

            modelBuilder.Entity("Pim.Module.PcTracker.Entities.PcBrowserSiteTickEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("pc_browser_site_tick");
                });
            ...
            modelBuilder.Entity("Pim.Module.PcTracker.Entities.PcSuggestionFeedbackEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("AcceptedCategoryId")
                        .HasColumnType("uuid")
                        .HasColumnName("accepted_category_id");
                    ...
                    b.HasIndex("Action")
                        .HasDatabaseName("ix_pc_suggestion_feedback_action");

                    b.HasIndex("Domain")
                        .HasDatabaseName("ix_pc_suggestion_feedback_domain");

                    b.HasIndex("ProcessName")
                        .HasDatabaseName("ix_pc_suggestion_feedback_process");

                    b.ToTable("pc_suggestion_feedback", (string)null);
                });

            modelBuilder.Entity("Pim.Module.PcTracker.Entities.TrackerEventEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool?>("Audible")
                        .HasColumnType("boolean")
                        .HasColumnName("audible");
                    ...
                    b.Property<int>("PageVisitCount")
                        .HasColumnType("integer")
                        .HasColumnName("page_visit_count");

                    b.Property<double>("PageVisitDuration")
                        .HasColumnType("double precision")
                        .HasColumnName("page_visit_duration");
                    ...
                    b.ToTable("pc_tracker_events");
                });

            modelBuilder.Entity("Pim.Module.PcTracker.Entities.TrackerHealthEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("BrowserConnected")
                        .HasColumnType("boolean")
                        .HasColumnName("browser_connected");

                    b.Property<double?>("BrowserHeartbeatAgeSeconds")
                        .HasColumnType("double precision")
                        .HasColumnName("browser_heartbeat_age_seconds");
                    ...
                    b.Property<long>("EventsUploaded")
                        .HasColumnType("bigint")
                        .HasColumnName("events_uploaded");

                    b.Property<bool>("HookActive")
                        .HasColumnType("boolean")
                        .HasColumnName("hook_active");

                    b.Property<string>("LastError")
                        .HasColumnType("text")
                        .HasColumnName("last_error");

                    b.Property<long>("PollCount")
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("SessionsCreated")
                        .HasColumnType("bigint")
                        .HasColumnName("sessions_created");

                    b.Property<bool>("SiteConnected")
                        .HasColumnType("boolean")
                        .HasColumnName("site_connected");

                    b.Property<long>("SiteEventsUploaded")
                        .HasColumnType("bigint")
                        .HasColumnName("site_events_uploaded");

                    b.Property<string>("SiteLastError")
                        .HasColumnType("text")
                        .HasColumnName("site_last_error");

                    b.Property<double?>("SiteLastEventAgeSeconds")
                        .HasColumnType("double precision")
                        .HasColumnName("site_last_event_age_seconds");
                    ...
                    b.Property<long>("UploadFailures")
                        .HasColumnType("bigint")
                        .HasColumnName("upload_failures");
            ...
            modelBuilder.Entity("Pim.Module.Calendar.Entities.EventEntity", b =>
                {
                    ...
                    b.HasOne("Pim.Module.Calendar.Entities.EventEntity", "SeriesMaster")
                        .WithMany()
